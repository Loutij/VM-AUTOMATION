#!/usr/bin/env python3
"""
Script pour vérifier l'état du déploiement DEMO_LATEST.
"""
...
async def check_demo_latest():
    """Vérifie l'état du déploiement DEMO_LATEST."""
    async with db_session() as session:
        ...
        if not deployments:
            print("❌ Aucun déploiement trouvé avec le nom 'DEMO_LATEST'")
            return
        
        print(f"✅ Trouvé {len(deployments)} déploiement(s) pour DEMO_LATEST\n")
