      ...
      <div className="flex items-center gap-4">
        ...
        <div className="relative">
          ...
          <input
            ...
            className="w-64 pl-10 pr-4 py-2 bg-light-100 dark:bg-dark-700 border border-light-300 dark:border-dark-600 rounded-lg text-gray-900 dark:text-dark-100 placeholder-gray-400 dark:placeholder-dark-400 focus:outline-none focus:ring-2 focus:ring-oto-500 focus:border-transparent transition-all"
          />
        </div>
